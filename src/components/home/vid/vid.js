         ...
         <div className="vid">
            ...
            <div className="row">
               <div className="col-md-offset-3 col-md-6">
                  <iframe title="byron-printing" className="vid-border" width="100%" height="350" frameBorder="0" seamless="seamless" src="https://www.youtube.com/embed/M1FBGHxHwsI" allowFullScreen></iframe>
               </div>
               <div className="col-md-offset-2 col-md-8">
